...
export default function PrivacyPolicy() {
  return (
    <div className="xl:m-10 m-4">
      <div className="flex flex-row xl:gap-10 gap-2 justify-center xl:justify-normal items-center">
        <h1 className="text-4xl font-bold">Privacy Policy</h1>
        <Image src="/a_main_black.png" width={80} height={80} alt="logo" />
      </div>
      <p className="text-xl my-4">Last updated: May 23, 2024</p>
      <p className="m-6">
      ...
      <h3 className="text-2xl font-bold my-4">Interpretation</h3>
      <p className="m-6">
      ...
      <h3 className="text-2xl font-bold my-4">Definitions</h3>
      <ul className="m-6">
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Apollo, the software program
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Apollo.
          </p>
        </li>
        <li>
          <p>
      ...
      <h3 className="text-2xl font-bold my-4">Types of Data Collected</h3>
      <h4 className="text-xl font-bold my-2">Personal Data</h4>
      <p className="m-6">
      ...
      <h4 className="text-xl font-bold my-2">Usage Data</h4>
      <p className="m-6">
      ...
      <h3 className="text-2xl font-bold my-4">Use of Your Personal Data</h3>
      <p className="m-6">
      ...
      <h3 className="text-2xl font-bold my-4">Delete Your Personal Data</h3>
      <p className="m-6">
      ...
      <h4 className="text-xl font-bold my-2">Business Transactions</h4>
      <p className="m-6">
      ...
      <h4 className="text-xl font-bold my-2">Law enforcement</h4>
      <p className="m-6">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="text-xl font-bold my-2">Other legal requirements</h4>
      <p className="m-6">
      ...
      <h2 className="text-3xl font-bold my-10">Children's Privacy</h2>
      <p className="m-6">
      ...
      <h2 className="text-3xl font-bold my-10">Links to Other Websites</h2>
      <p className="m-6">
      ...
      <h2 className="text-3xl font-bold my-10">Contact Us</h2>
      <p>
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul className="m-6">
        <li>By email: msaturczakk@gmail.com</li>
      </ul>
    </div>
  );
}
