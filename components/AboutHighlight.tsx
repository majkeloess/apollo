  ...
  return (
    <HeroHighlight2 margin="my-2">
      <motion.h1
        ...
        className="text-4xl px-4 md:text-4xl lg:text-5xl font-bold text-neutral-700 dark:text-white max-w-3xl max-h-xl leading-relaxed lg:leading-snug text-center mx-auto "
      >
        Become{" "}
