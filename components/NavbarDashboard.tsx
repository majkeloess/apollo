...
export default async function NavbarDashboard() {
  ...
  return (
    <MotionDiv
      ...
      whileInView="show"
    >
      <ul className="flex flex-row justify-center  md:justify-evenly items-center gap-12 lg:gap-6 my-5">
        <li className="flex flex-row gap-10 items-center text-xl">
        ...
        <li>
          <ul className="flex flex-row">
            <li className="flex xl:justify-end items-center gap-4">
              <SignOut />
              <ModeToggle />
            </li>
          </ul>
